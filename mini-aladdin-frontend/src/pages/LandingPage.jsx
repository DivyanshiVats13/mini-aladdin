            ...
            <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1.25rem 3rem', borderBottom: '1px solid #E5E7EB' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <button onClick={handleDemoLogin} disabled={demoLoading}
                        style={{ padding: '0.5rem 1rem', fontSize: '0.875rem', fontWeight: 600, color: '#fff', background: '#059669', borderRadius: '0.5rem', border: 'none', cursor: demoLoading ? 'wait' : 'pointer' }}>
